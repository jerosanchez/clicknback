...
- **Feature flag system**: features can be enabled/disabled at runtime, globally or per-merchant/user ([ADR-018](docs/design/adr/018-feature-flag-system.md)). Enables testing scenarios where manual purchase confirmation is needed without waiting for automatic background job confirmation.
